  ...
  gentleman: [
    {
      id: "mike-jacket",
      label: "ミケ（ジャケット）",
      image: "/characters/art/mike_04_jacket.png",
      focus: "50% 50%",
      emoji: "🤵",
      keyword: "身軽な誠実",
    ...
    },
    {
      id: "mike-suit",
      label: "ミケ（スーツ）",
      image: "/characters/art/mike_06_suit.png",
      focus: "50% 50%",
      emoji: "🤵",
      keyword: "礼節の鉄壁",
    ...
    },
    {
      id: "lop-dressup",
      label: "ロップ（おめかし）",
      image: "/characters/art/lop_04_dressup.png",
      focus: "44% 50%",
      emoji: "🤵",
      keyword: "微笑みの交渉術",
  ...
  hot_blooded: [
    {
      id: "mike-apron",
      label: "ミケ（エプロン）",
      image: "/characters/art/mike_07_apron.png",
      focus: "48% 50%",
      emoji: "😤",
      keyword: "情熱の突撃隊長",
    ...
    },
    {
      id: "zenny-cap",
      label: "ゼニー（キャップ）",
      image: "/characters/art/zenny_01_cap.png",
      focus: "44% 50%",
      emoji: "😤",
      keyword: "根拠なき自信",
    ...
    },
    {
      id: "zenny-hachimaki",
      label: "ゼニー（はちまき）",
      image: "/characters/art/zenny_05_headband.png",
      focus: "50% 50%",
      emoji: "😤",
      keyword: "本気の空回り",
  ...
  listener: [
    {
      id: "mike-knit",
      label: "ミケ（ニット帽）",
      image: "/characters/art/mike_05_knit_hat.png",
      focus: "50% 50%",
      emoji: "🕊️",
      keyword: "沈黙の共感力",
    ...
    },
    {
      id: "mike-parka",
      label: "ミケ（パーカー）",
      image: "/characters/art/mike_10_parker.png",
      focus: "50% 50%",
      emoji: "🕊️",
      keyword: "静かなる粘り",
    ...
    },
    {
      id: "zenny-parka",
      label: "ゼニー（パーカー）",
      image: "/characters/art/zenny_06_parker.png",
      focus: "46% 50%",
      emoji: "🕊️",
      keyword: "気配りの達人",
  ...
  mypace: [
    {
      id: "mike-sweater",
      label: "ミケ（セーター）",
      image: "/characters/art/mike_03_sweater.png",
      focus: "50% 50%",
      emoji: "😌",
      keyword: "脱力の達人",
    ...
    },
    {
      id: "zenny-sunglasses",
      label: "ゼニー（サングラス）",
      image: "/characters/art/zenny_04_sunglasses.png",
      focus: "50% 50%",
      emoji: "😌",
      keyword: "休暇中の交渉人",
    ...
    },
    {
      id: "mike-pajama",
      label: "ミケ（ねこパジャマ）",
      image: "/characters/art/mike_11_pajama.png",
      focus: "50% 50%",
      emoji: "😌",
      keyword: "眠たげな安心感",
